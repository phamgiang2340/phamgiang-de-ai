...
Với schema trong assignment lần này: Chọn phương án của trường hợp 1, lúc này database mới chỉ ở dạng schema, chưa có dữ liệu, nếu việc tạo lại giúp cho quá trình vận hành sau này trở nên đơn giản hơn thì tôi sẽ chọn phương án tạo lại.